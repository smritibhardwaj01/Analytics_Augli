function drawWordcoach(data)
{
        ...
        for(a in data){
            ...
            var container = d3.select("#wordcoach").append("svg").attr("width",120).attr("height",250)
        ...
        var xContainer = d3.select("#wordcoach").append("svg").attr("width",710).attr("height",50)
                .attr("x",0)
                .attr("y",210)
                .attr("transform","translate(100,-225)");
        
        var yContainer = d3.select("#wordcoach").append("svg").attr("width",35).attr("height",270)
        ...
        var legend = d3.select("#wordcoach").append("svg").attr("width",150).attr("height",100)
