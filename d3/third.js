function cp(data){
    ...
    var x = d3.scaleLinear().domain([0,300]).range([0,  width-150]);
    var y = d3.scaleLinear().domain([0, height]).range([height, 0]);

    var xScale = d3.scaleLinear().domain([]).range([0, width-150]);
    ...
    var canvas = d3.select("#third").append("svg").attr("class","percentage")
    .attr("width",width)
    .attr("height", height)
    ...
    canvas.selectAll("rect")
        ...
        .attr("transform","translate(100,-100)");
            ...
            var xLabel = ["Core (Grammar)","Pronunciation","Reading","Summarization","Vocabulary","Asessment"];
            ...
            canvas.selectAll("#xLabel")
                ...
                .attr("class","text2")
                .attr("y",200)
                .attr("x",function(d,i){ return (i*80)+40/2})
                .attr("transform","translate(85,120)")
                .attr("fill","#A9A9A9")
                .attr("font-size",12)

            var xName = ["Activity"];
            var yName = ["Percentage"]
...
function cn(data){
    ...
    var canvas = d3.select("#third").append("svg").attr("class","frequency")
    .attr("width",width)
    .attr("height", height)
        ...
        if(text == "All" || text == "Schools"){
            ...
            if( date == "Till Date"){
                ...
                // console.log(testDate);
                    ...
                    // d3.select("#third").data(array1).enter().call(function(d){ console.log(d);cp(d); })
                    cp(array1);
                    ...
                    // d3.select("#third").data(array1).enter().call(function(d){ console.log(d);cn(d); })
                    cn(array2);
            ...
            .on("change",function(d){
                d3.select("#third").selectAll("svg").remove();
                ...
                // d3.select("#third").data(array1).enter().call(function(d){ cp(d); })
                cp(array1);
                    ...
                    // d3.select("#third").data(array1).enter().call(function(d){ cn(d); })
                    cn(array2);
                })
        }
        d3.select("#selected-dropdown").text("All");
